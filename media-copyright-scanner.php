    ...
    if ( $notice_link ) {
        ...
        <div class="notice notice-error">
            <p>
                ...
                echo wp_kses_post(
                    sprintf(
                        __( 'My Plugin has been deactivated because it cannot be used on WordPress.com-hosted websites. %s', 'media-copyright-scanner' ),
                        '<a href="' . esc_url( $notice_link ) . '" target="_blank" rel="noopener">' . __( 'Learn more', 'media-copyright-scanner' ) . '</a>'
                    )
                );
                ?>
            </p>
        ...
        wp_die(
            wp_kses_post(
                sprintf(
                    ...
                    __( 'Plugin Activation Blocked', 'media-copyright-scanner' ),
                    __( 'This plugin cannot be activated on WordPress.com-hosted websites. It is restricted due to concerns about WordPress.com policies impacting the community.', 'media-copyright-scanner' ),
                    esc_url( 'https://robertdevore.com/why-this-plugin-doesnt-support-wordpress-com-hosting/' ),
                    __( 'Learn more', 'media-copyright-scanner' )
                )
            ),
            esc_html__( 'Plugin Activation Blocked', 'media-copyright-scanner' ),
            [ 'back_link' => true ]
        );
    }
}
